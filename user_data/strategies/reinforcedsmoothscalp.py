...
class ReinforcedSmoothScalp(IStrategy):
    ...
    buy_adx = IntParameter(20, 50, default=48, space='buy')
    buy_fastd = IntParameter(15, 45, default=32, space='buy')
    buy_fastk = IntParameter(15, 45, default=35, space='buy')
    buy_mfi = IntParameter(10, 25, default=14, space='buy')
    buy_adx_enabled = BooleanParameter(default=True, space='buy')
    buy_fastd_enabled = BooleanParameter(default=False, space='buy')
    buy_fastk_enabled = BooleanParameter(default=False, space='buy')
    buy_mfi_enabled = BooleanParameter(default=False, space='buy')

    sell_adx = IntParameter(50, 100, default=76, space='sell')
    sell_cci = IntParameter(100, 200, default=179, space='sell')
    sell_fastd = IntParameter(50, 100, default=59, space='sell')
    sell_fastk = IntParameter(50, 100, default=58, space='sell')
    sell_mfi = IntParameter(75, 100, default=76, space='sell')

    sell_adx_enabled = BooleanParameter(default=True, space='sell')
    sell_cci_enabled = BooleanParameter(default=False, space='sell')
